...
<head>
    ...
    <title>180 Foodhouse - Início</title>
...
<body>
    ...
    <div class="min-vh-100 d-flex justify-content-center align-items-center inici">
        <div class="div_inicial mb-5 shadow-box">
            <h1><strong>Bem-vindo, <?= htmlspecialchars($_SESSION['nome']) ?>!</strong></h1>
            <p>O que deseja fazer?</p>
            <a href="../admin/pagamento.php" class="zap">Relatórios</a>
            <a href="../admin/txs.php" class="zap">Logistico</a>
            <a href="../admin/cadastros.php" class="zap">Usuários</a><br>
    ...
    <script src="../../JS/admin/inicial.js"></script>
</body>
</html>